...
* **Core Synthesis (Design Compiler):** Synthesized the core logic utilizing **Synopsys Design Compiler** with the **45nm Nangate PDK** at 250 MHz and 1.1V. The synthesized logic yielded:
  - **Logic Area:** 0.0458 cm^2
  - **Standard Cell Count:** ~2 million cells (1.432 million combinational, 621,000 sequential)
  - **Dynamic Power:** 90.74 mW
  - **Leakage Power:** 98.42 mW
* **SRAM Macro Modeling (CACTI 7):** Because standard compilers do not synthesize SRAM arrays efficiently, **CACTI 7** was used to model the area, read/write energy, and leakage power of the caches:
  - **Baseline D-Cache Area & Leakage:** 0.363x0.457 mm bounding box, 54.41 mW leakage power at 2.14 GHz operational frequency (read energy 0.026 nJ, write energy 0.036 nJ).
  - **Baseline I-Cache Area & Leakage:** 0.362x0.237 mm bounding box, 28.64 mW leakage power at 3.03 GHz operational frequency (read energy 0.013 nJ, write energy 0.023 nJ).
  - **Elongated Layout Trade-offs:** Analyzed non-uniform, highly associative cache layouts (e.g. 16-way D-Cache with 0.198x0.733 mm bounding box). This elongated structure introduced unbalanced critical paths, degrading maximum frequency from 2.14 GHz to 1.18 GHz.
